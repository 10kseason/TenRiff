TenRiff source package notes (`1.3.3`)
...
- The current source line is `1.3.3`; it carries the UI-r2 Song Select and animated Result flows, adds direct left/right quick-setting controls and record/layout fixes, and keeps optional local profile avatars, the TenRiff skin format, and ranked-clear exclusion for Autoplay.

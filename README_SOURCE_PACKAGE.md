TenRiff source package notes (`1.3.7`)
...
- The current source line is `1.3.7`; it brightens the hit explosion, widens the default judgement windows to 20/65/115 ms, removes long-note tail correction, adds judgement-line/hi-speed/latency tuning to the pause screen, de-duplicates keysounds shared across a chord, and adds FAST/SLOW and gauge-axis readouts to the result screen.

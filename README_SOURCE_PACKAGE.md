TenRiff source package notes (`1.3.0 UI-r2`)
...
- The current source line is `1.3.0 UI-r2`; it adds the redesigned Song Select and animated Result flows, optional local profile avatars, the TenRiff skin format, and ranked-clear exclusion for Autoplay while retaining the `1.3.0` runtime version.

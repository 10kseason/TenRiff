TenRiff source package notes (`1.1.4 stable`)
...
- The current source line is the `1.1.4 stable` release, including direct-IP multiplayer and the latest input/judgement fixes.

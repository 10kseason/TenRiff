TenRiff source package notes (`1.3.9`)
...
- The current source line is `1.3.9`; it adds configurable hit-burst styles with a sustained long-note effect, an eight-card options hub, score maximums and revised result labels, more robust video BGA fallback/retry handling, and Unicode-safe LR2 skin path handling.

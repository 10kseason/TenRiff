...
The versioned public source bundles (packages such as `TenRiff-1.0.7-source.zip`) include `external/`, `src/`, `tests/`, `config/`, `docs/`, and `Mainmusic/`, so they can be configured and built directly after extraction.

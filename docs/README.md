...
3. `docs/baseline-0.9.92.md`
   - 현재 작업을 어디서부터 쌓아야 하는지 정하는 `0.9.92` 기준선 문서
...
- `docs/current-state.md`
  - 현재 구현 상태의 요약 문서
- `docs/baseline-0.9.92.md`
  - 후속 작업이 유지해야 하는 `0.9.92` 기준선 문서
- `docs/config.md`
...
- 어떤 기준선 위에서 작업을 쌓는지 정할 때는 `docs/baseline-0.9.92.md`를 같이 봅니다.

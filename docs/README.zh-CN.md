...
2. [`docs/baseline-0.9.92.zh-CN.md`](baseline-0.9.92.zh-CN.md)
   - 规定当前工作应从哪里继续叠加的 `0.9.92` 基准文档
...
- [`docs/current-state.zh-CN.md`](current-state.zh-CN.md)
  - 当前实现状态的总结文档
- [`docs/baseline-0.9.92.zh-CN.md`](baseline-0.9.92.zh-CN.md)
  - 后续工作必须保持的 `0.9.92` 基准文档
...
- 在确认应当在哪个基准上继续叠加工作时，要同时看 [`docs/baseline-0.9.92.zh-CN.md`](baseline-0.9.92.zh-CN.md)。

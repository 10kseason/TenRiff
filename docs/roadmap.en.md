...
- Project version line is `1.2.2 stable`; this release adds MPG/MPEG video BGA decoding with an FFmpeg fallback and places the staged32 RGB FP16 LunaSR model behind a mandatory 200 FPS safety gate.

...
- プロジェクト版ラインは `1.2.3 stable` で、FFmpeg fallback 付き MPG/MPEG 動画 BGA decode を維持し、staged32 RGB INT8 QDQ LunaSR model を 35 FPS gate で使用します。`RTX 3070 クラス以上`は推定推奨であり、保証要件ではありません。

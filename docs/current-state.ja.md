...
- Graphics:
  ...
  - `visual_offset_ms`
  - `performance_overlay`
  - `background_upscale_mode=lunasr|off`: staged32 RGB FP16 WinML 推論 benchmark が 200 FPS 以上の場合だけ画像・動画 BGA を FHD x2 処理し、MPG/MPEG は Media Foundation 失敗時に FFmpeg fallback を使用

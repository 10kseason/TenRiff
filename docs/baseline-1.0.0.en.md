...
## Release Identity
- Baseline release line: `1.0.0`
- Current main target: Windows GUI build
- Default product surface: BMS-first
- Optional extension surface: `.osu` osu!mania 4K-10K
- Distribution paths:
  - Windows package: `Baepoks/TenRiff-1.0.0`
  - Public source package: `opensource-Tenriff-source/TenRiff-1.0.0-source`
...
- Future work should favor additive changes that do not break the `1.0.0` baseline.
...
- The `1.0.0` packaging rules and no-songs distribution layout

...
- The last staged distribution package is `Baepoks/TenRiff-1.0.3`
...
- The last staged public source package is versioned separately, e.g. `opensource-Tenriff-source/TenRiff-1.0.3-source`

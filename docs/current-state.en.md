...
- The last staged distribution package is `Baepoks/TenRiff-1.0.0`
...
- The last staged public source package is versioned separately, e.g. `opensource-Tenriff-source/TenRiff-1.0.0-source`
...
- `cmake -S opensource-Tenriff-source/TenRiff-1.0.0-source -B opensource-Tenriff-source/TenRiff-1.0.0-source/build-check -G "Visual Studio 17 2022" -A x64`
- `cmake --build opensource-Tenriff-source/TenRiff-1.0.0-source/build-check --config Release --target bms_parser_tests`
- `opensource-Tenriff-source/TenRiff-1.0.0-source/build-check/Release/bms_parser_tests.exe`

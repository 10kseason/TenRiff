...
## Baseline
- Current stable release line: `1.4.5.2`
...
- BMS key modes:
  ...
  - official 1.4.5.2 builds/Windows archives do not build or ship the standalone BMS key-converter CLI/GUI; its top-level CMake option defaults `OFF` and the source is retained only for development regression
...
- The current stable P2P distribution line is `TenRiff 1.4.5.2`

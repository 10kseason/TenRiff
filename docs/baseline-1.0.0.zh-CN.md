...
这份文档是后续继续推进 TenRiff 工作时应当遵循的 `1.0.0` 基准文档。目的在于快速固定“当前默认值是什么、哪些行为必须保留、下一步工作应在什么范围内叠加”。
...
- 发布基准路径：
  - Windows 包：`Baepoks/TenRiff-1.0.0`
  - 公开源代码包：`opensource-Tenriff-source/TenRiff-1.0.0-source`

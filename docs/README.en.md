...
2. `docs/baseline-0.8.0.en.md`
   - The `0.8.0` baseline document that defines what the current work should be stacked on top of
...
- `docs/baseline-0.8.0.en.md`
  - The `0.8.0` baseline document that follow-up work should preserve
- `docs/config.en.md`
...
- When deciding what baseline to build on, read `docs/baseline-0.8.0.en.md` together with it.
